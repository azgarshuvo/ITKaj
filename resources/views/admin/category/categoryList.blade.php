            ...
            <tr class="gradeX">
              ...
              <td class="center">
                ...
                {{--<a class="btn btn-sm btn-danger" href="" data-href="{{ route('categoryDelete', $pc->id)}}"  data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-times"></i></a>--}}
                  <a onclick="return confirm('Are you sure to delete?')" class="btn btn-sm btn-danger" href="{{ route('categoryDelete', $pc->id)}}"  data-toggle="tooltip" title="Job Delete"><i class="fa fa-times" ></i></a>
              </td>
            </tr>
            @endforeach
          </tbody>
