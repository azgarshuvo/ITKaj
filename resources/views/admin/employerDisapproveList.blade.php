                    ...
                    @foreach($employerDisapproveList as $employer)
                        @if($employer->profile != null && $employer->profile != "")
                            <tr class="gradeX">
                                ...
                                <td class="center">
                                    <a onclick="return confirm('Are you sure to delete?')" class="btn btn-sm btn-danger" href="{{ route('employeerDisapproveDelete', $employer->id)}}"  data-toggle="tooltip" title="Job Delete"><i class="fa fa-times" ></i></a>
                                    {{--<a class="btn btn-sm btn-danger" href="" data-href="{{ route('employeerDisapproveDelete', $employer->id)}}" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-times"></i></a>--}}
