                    ...
                    @foreach($freelancerDisapproveList as $freelancer)
                        @if($freelancer->profile != null && $freelancer->profile != "")
                            <tr class="gradeX">
                                ...
                                <td class="center">
                                    <a onclick="return confirm('Are you sure to delete?')" class="btn btn-sm btn-danger" href="{{ route('freelancerDisapproveDelete', $freelancer->id)}}"  data-toggle="tooltip" title="Job Delete"><i class="fa fa-times" ></i></a>
