...
@section('title', 'Job Disapproved List')
...
@section('content')
   ...
   <div class="col-md-9">
    ...
    <div class="breadcrumbs">
        <div class="container">
            <h1 class="pull-left">Disapproved Job Search</h1>
        </div><!--/container-->
    </div>
    ...
    <!--Basic Table-->
                    <div class="panel panel-green margin-bottom-40 ">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-tasks"></i> Disapproved Job List Table</h3>
                        </div>
                        <div class="panel-body jobDisapproveListTable">
